...
<head>
    ...
    <title>Figure Out! | Detalles del Producto</title>
    ...
    <main class="container mt-5">
        <div class="row">
            ...
            <br>
                 <?php
                     ...
                     echo '<p class="card-category">Categoría: <a href="Dashboard2Categoria.php?categoryid=' .$product_categoryid. '">'.$product_category.'</a></p>';
        ...
        <div class="mt-5">
            ...
            while ($row = $comentarios->fetch_assoc()) 
            {
                ...
                $usuario_priv = $row['usuario_priv'];

              echo'<div class="media">';
              echo' <img id="idPComentAvatar" src="data:image/jpeg;base64,'.$usuari_imagen.'"
                   class="mr-3 rounded-circle" alt="Usuario">';
              echo'    <div class="media-body">';
              echo'    <h5 class="mt-0" >'.$usuari.'</h5>';
              if($usuario_priv == "1"){
                echo'    <h5 class="mt-0" > Usuario Publico</h5>';
              }
              if($usuario_priv == "2"){
                echo'    <h5 class="mt-0" > Usuario Privado</h5>';
              }
              echo'     <p>'.$coment.'</p>';
              echo' </div>';
              echo'</div>';
