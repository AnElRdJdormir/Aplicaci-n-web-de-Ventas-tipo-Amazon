...
<html lang="en">
    ...
    <meta charset="UTF-8">
        ...
        <title>Figure Out! | Editar Producto</title>
    ...
    if($usuario_type =="2")
    {
        ...
        <div id="idAltaProducto" class="container-fluid">
            <form  id="idForm" action="editarproducto.php" method="POST" enctype="multipart/form-data">
            <?php  echo '<input type="hidden" name="producto_id" 
                           id="producto_id" value="'.$producto_id.'">';
                    ?>
            
                <div class="row">
                    <div id="idAPInfoContainer" class="col-5">
                        <div class="row">
                            <label id="idAPTitulo" class="text">Editar producto</label>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="d-flex justify-content-between">
                                    <button id="btnAltadeProducto" type="submit">Editar Producto</button>
                                </div>
                            </div>
                        </div>
                    </div>
